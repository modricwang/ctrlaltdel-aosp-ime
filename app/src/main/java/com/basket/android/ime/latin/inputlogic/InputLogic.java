...
package com.basket.aosp.ime.latin.inputlogic;
...
import com.basket.aosp.ime.compat.SuggestionSpanUtils;
...
import com.basket.aosp.ime.latin.Dictionary;
import com.basket.aosp.ime.latin.DictionaryFacilitator;
import com.basket.aosp.ime.latin.LastComposedWord;
import com.basket.aosp.ime.latin.LatinIME;
import com.basket.aosp.ime.latin.NgramContext;
import com.basket.aosp.ime.latin.RichInputConnection;
import com.basket.aosp.ime.latin.Suggest;
import com.basket.aosp.ime.latin.Suggest.OnGetSuggestedWordsCallback;
import com.basket.aosp.ime.latin.SuggestedWords;
import com.basket.aosp.ime.latin.SuggestedWords.SuggestedWordInfo;
import com.basket.aosp.ime.latin.WordComposer;
import com.basket.aosp.ime.latin.common.Constants;
import com.basket.aosp.ime.latin.common.InputPointers;
import com.basket.aosp.ime.latin.common.StringUtils;
import com.basket.aosp.ime.latin.define.DebugFlags;
import com.basket.aosp.ime.latin.settings.SettingsValues;
import com.basket.aosp.ime.latin.settings.SettingsValuesForSuggestion;
import com.basket.aosp.ime.latin.settings.SpacingAndPunctuations;
import com.basket.aosp.ime.latin.suggestions.SuggestionStripViewAccessor;
import com.basket.aosp.ime.latin.utils.AsyncResultHolder;
import com.basket.aosp.ime.latin.utils.InputTypeUtils;
import com.basket.aosp.ime.latin.utils.RecapitalizeStatus;
import com.basket.aosp.ime.latin.utils.StatsUtils;
import com.basket.aosp.ime.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link com.basket.aosp.ime.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link com.basket.aosp.ime.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link com.basket.aosp.ime.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, com.basket.aosp.ime.latin.SuggestedWords)}.

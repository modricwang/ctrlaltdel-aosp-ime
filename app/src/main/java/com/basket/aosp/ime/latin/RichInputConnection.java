...
import com.basket.aosp.ime.compat.InputConnectionCompatUtils;
import com.basket.aosp.ime.latin.common.Constants;
import com.basket.aosp.ime.latin.common.UnicodeSurrogate;
import com.basket.aosp.ime.latin.common.StringUtils;
import com.basket.aosp.ime.latin.inputlogic.PrivateCommandPerformer;
import com.basket.aosp.ime.latin.settings.SpacingAndPunctuations;
import com.basket.aosp.ime.latin.utils.CapsModeUtils;
import com.basket.aosp.ime.latin.utils.DebugLogUtils;
import com.basket.aosp.ime.latin.utils.NgramContextUtils;
import com.basket.aosp.ime.latin.utils.ScriptUtils;
import com.basket.aosp.ime.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.basket.aosp.ime.latin.common.Constants.UnicodeSurrogate

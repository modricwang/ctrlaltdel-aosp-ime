...
package io.github.ctrlaltdel.aosp.ime.latin.inputlogic;
...
import io.github.ctrlaltdel.aosp.ime.compat.SuggestionSpanUtils;
...
import io.github.ctrlaltdel.aosp.ime.latin.Dictionary;
import io.github.ctrlaltdel.aosp.ime.latin.DictionaryFacilitator;
import io.github.ctrlaltdel.aosp.ime.latin.LastComposedWord;
import io.github.ctrlaltdel.aosp.ime.latin.LatinIME;
import io.github.ctrlaltdel.aosp.ime.latin.NgramContext;
import io.github.ctrlaltdel.aosp.ime.latin.RichInputConnection;
import io.github.ctrlaltdel.aosp.ime.latin.Suggest;
...
import io.github.ctrlaltdel.aosp.ime.latin.common.StringUtils;
...
import io.github.ctrlaltdel.aosp.ime.latin.settings.SettingsValuesForSuggestion;
import io.github.ctrlaltdel.aosp.ime.latin.settings.SpacingAndPunctuations;
import io.github.ctrlaltdel.aosp.ime.latin.suggestions.SuggestionStripViewAccessor;
import io.github.ctrlaltdel.aosp.ime.latin.utils.AsyncResultHolder;
import io.github.ctrlaltdel.aosp.ime.latin.utils.InputTypeUtils;
import io.github.ctrlaltdel.aosp.ime.latin.utils.RecapitalizeStatus;
import io.github.ctrlaltdel.aosp.ime.latin.utils.StatsUtils;
import io.github.ctrlaltdel.aosp.ime.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link io.github.ctrlaltdel.aosp.ime.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link io.github.ctrlaltdel.aosp.ime.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link io.github.ctrlaltdel.aosp.ime.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, io.github.ctrlaltdel.aosp.ime.latin.SuggestedWords)}.
